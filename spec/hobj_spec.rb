...
describe HierarchicalObject, "when building a tree of objects" do
  ...
  it "should increment a mvgid coded base159 number" do
    ...
    HierarchicalObject.mvgid_base159_incr(
      HierarchicalObject.tomvgID( HierarchicalObject.toBase159( 400160 ) )
    ).should eql( HierarchicalObject.toBase159( 400161 ) )

    HierarchicalObject.mvgid_base159_incr(
      HierarchicalObject.tomvgID( HierarchicalObject.toBase159( 54321000 ) )
    ).should eql( HierarchicalObject.toBase159( 54321001 ) )
  end
